...
import table.JourneyTable;
import table.RouteTable;
import table.Table;
...
public class Database {
    ...
    public void init() throws ParseException {
        ...
        for (int i = 0; i <= journeyTable.getRowCount(); i++) {
            ...
            this.backJourneyTable.insertBack(
                    Arrays.asList((String) journeyTable.getValueAt(i, 0), sdf0.format(dt0),
    ...
    public static void main(String[] args) throws ParseException {
        ...
        trainDatabase.clear();
        trainDatabase.trainTable.insertBack(Arrays.asList("#1001", "Freedom"));
        trainDatabase.trainTable.insertBack(Arrays.asList("#1002", "Democracy"));
        trainDatabase.trainTable.insertBack(Arrays.asList("#1003", "Queen"));
        trainDatabase.trainTable.insertBack(Arrays.asList("#1004", "Prince"));
        trainDatabase.trainTable.insertBack(Arrays.asList("#1005", "Science"));
        trainDatabase.driverTable.insertBack(Arrays.asList("#2001", "Tom"));
        trainDatabase.driverTable.insertBack(Arrays.asList("#2002", "Mike"));
        trainDatabase.driverTable.insertBack(Arrays.asList("#2003", "James"));
        trainDatabase.driverTable.insertBack(Arrays.asList("#2004", "Andrew"));
        trainDatabase.driverTable.insertBack(Arrays.asList("#2005", "Edison"));
        trainDatabase.routeTable.insertBack(Arrays.asList("#3001", "A", "C", "E", "G"));
        trainDatabase.routeTable.insertBack(Arrays.asList("#3002", "E", "D", "A", "C"));
        trainDatabase.routeTable.insertBack(Arrays.asList("#3003", "D", "F", "B", "A"));
        trainDatabase.routeTable.insertBack(Arrays.asList("#3004", "C", "A", "E", "B"));
        trainDatabase.routeTable.insertBack(Arrays.asList("#3005", "B", "A", "G", "F"));
        trainDatabase.journeyTable.insertBack(Arrays.asList("#4001", "#3001", "#1001", "#2001", "08:00", "08:20", "08:40", "09:00", "09:20"));
        trainDatabase.journeyTable.insertBack(Arrays.asList("#4002", "#3002", "#1002", "#2002", "08:10", "08:30", "08:45", "09:05", "09:20"));
        trainDatabase.journeyTable.insertBack(Arrays.asList("#4003", "#3003", "#1003", "#2003", "09:00", "09:20", "09:40", "10:00", "10:20"));
        trainDatabase.journeyTable.insertBack(Arrays.asList("#4004", "#3004", "#1004", "#2004", "12:00", "12:20", "12:40", "13:00", "13:20"));
        trainDatabase.journeyTable.insertBack(Arrays.asList("#4005", "#3005", "#1005", "#2005", "13:00", "13:20", "13:40", "14:00", "14:20"));
